...
$ curl 'http://localhost:8080/enterprise' -i -X PUT \
    ...
    -H 'Authorization: eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlbnRlcnByaXNlSWQiLCJpYXQiOjE2NTIxODIzNjAsImV4cCI6MTY1MjE4MjQ0Nn0.A_vNSB7LHRf8stu0jg-arwD0hITT06YVNKOq30lazic' \
    -d '{
