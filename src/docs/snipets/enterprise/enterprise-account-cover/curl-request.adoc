...
$ curl 'http://localhost:8080/enterprise' -i -X PUT \
    ...
    -H 'Authorization: eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlbnRlcnByaXNlSWQiLCJpYXQiOjE2NTM2NjA4NTQsImV4cCI6MTY1MzY2MDk0MX0.yzyX4h7MhSPDQR_-n8OJJ1N5_rVcMNBzYLUwu1CGke0' \
    -d '{
