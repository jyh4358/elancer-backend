...
public class ProcessingProjectResponse {
    ...
    private int processingFreelancerCount;
    private List<WaitFreelancerDto> waitFreelancerDto = new ArrayList<>();

    @Builder

    public ProcessingProjectResponse(Long projectNum,
                                     String projectName,
                                     ...
                                     int processingFreelancerCount,
                                     List<WaitFreelancerDto> waitFreelancerDto) {
        ...
        this.processingFreelancerCount = processingFreelancerCount;
        this.waitFreelancerDto = waitFreelancerDto;
    }

    public static ProcessingProjectResponse of(Project project,
                                               int processingFreelancerCount,
                                               List<WaitFreelancerDto> waitFreelancerDto) {
        return ProcessingProjectResponse.builder()
                ...
                .processingFreelancerCount(processingFreelancerCount)
                .waitFreelancerDto(waitFreelancerDto)
                .build();
    }
}
